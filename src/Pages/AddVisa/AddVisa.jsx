...
export default function AddVisa() {
  ...
  return (
   <div>
    ...
    <form onSubmit={handleAddVisa} className="card-body w-full grid sm:grid-cols-1 md:grid-cols-2 gap-5">
      ...
      <div className="form-control mt-3 sm:col-span-2 md:col-span-1">
